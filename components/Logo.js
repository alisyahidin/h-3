...
export const LogoSVG = forwardRef(({ className, color, ...props }, ref) => (
  <svg {...props} className={className} ref={ref} viewBox="0 0 114 142" fill="none" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
    <rect width="114" height="142" fill="url(#pattern0)" />
    <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="114" height="142">
      <rect width="114" height="142" fill="url(#pattern1)" />
    </mask>
    <g mask="url(#mask0)">
      <rect x="19" y="124" width="8" height="18" fill={color === 'light' ? '#48D7BD' : '#B72842'} />
    </g>
    <defs>
      <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
        <use href="#logo-image" transform="translate(-0.00235849) scale(0.00293777 0.00235849)" />
      </pattern>
