  ...
  return (<>
    <div className="w-full border-gray-300 border-2 p-3">
      {filled && (<>
        ...
        <button onClick={open} className="block bg-blue-200 mt-2 py-1 px-2 rounded">Choose Different Image</button>
        <button onClick={() => onChange('')} className="block bg-blue-200 mt-2 py-1 px-2 rounded">Delete Image</button>
      </>)}
